import { createContextScope } from '@briks/core';
import {
  useCallbackRef,
  useComposedRefs,
    ...
    return (
      ...
      >
        ...
        <Collection.Slot scope={__scopeToast}>
          <Primitive.div tabIndex={-1} {...viewportProps} ref={composedRefs} />
        </Collection.Slot>
        {hasToasts && (
          <FocusProxy
...
const FocusProxy = React.forwardRef<FocusProxyElement, ScopedProps<FocusProxyProps>>(
  ({ __scopeToast, onFocusFromOutsideViewport, ...proxyProps }, forwardedRef) => {
    ...
    return (
      <Presence present={forceMount || open}>
        <ToastImpl
          ...
          onSwipeStart={composeEventHandlers(toastProps.onSwipeStart, event => {
          ...
          onSwipeCancel={composeEventHandlers(toastProps.onSwipeCancel, event => {
            ...
            <Collection.ItemSlot scope={__scopeToast}>
              ...
              >
                <Primitive.div
                  ...
                  onKeyDown={composeEventHandlers(toastProps.onKeyDown, event => {
                  ...
                  onPointerDown={composeEventHandlers(toastProps.onPointerDown, event => {
                  ...
                  onPointerMove={composeEventHandlers(toastProps.onPointerMove, event => {
                  ...
                  onPointerUp={composeEventHandlers(toastProps.onPointerUp, event => {
...
const ToastTitle = React.forwardRef<ToastTitleElement, ToastTitleProps>(
  ({ __scopeToast, ...titleProps }: ScopedProps<ToastTitleProps>, forwardedRef) => (
...
const ToastDescription = React.forwardRef<ToastDescriptionElement, ToastDescriptionProps>(
  ({ __scopeToast, ...descriptionProps }: ScopedProps<ToastDescriptionProps>, forwardedRef) => (
...
const ToastAction = React.forwardRef<ToastActionElement, ToastActionProps>(
  ({ altText, ...actionProps }: ScopedProps<ToastActionProps>, forwardedRed) => {
...
const ToastClose = React.forwardRef<ToastCloseElement, ToastCloseProps>(
  ({ __scopeToast, ...closeProps }: ScopedProps<ToastCloseProps>, forwardedRef) => {
    ...
    return (
      <ToastAnnounceExclude asChild>
        <Primitive.button
          ...
          {...closeProps}
          ref={forwardedRef}
          onClick={composeEventHandlers(closeProps.onClick, interactiveContext.onClose)}
        />
      </ToastAnnounceExclude>
    );
  },
...
>(
  (
    { __scopeToast, altText, ...announceExcludeProps }: ScopedProps<ToastAnnounceExcludeProps>,
    forwardedRef,
  ) => (
    <Primitive.div

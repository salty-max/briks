...
import { useComposedRefs, useControllableState, usePrevious, useSize } from '@briks/hooks';
...
const SwitchThumb = React.forwardRef<SwitchThumbElement, SwitchThumbProps>(
  ({ __scopeSwitch, ...props }: ScopedProps<SwitchThumbProps>, forwardedRef) => {
    const context = useSwitchContext(SWITCH_NAME, __scopeSwitch);
...
const BubbleInput = ({ control, checked, bubbles = true, ...props }: BubbleInputProps) => {

import { createContextScope, isNotNull } from '@briks/core';
import { useCallbackRef, useComposedRefs, useLayoutEffect, useSize } from '@briks/hooks';
import {
...
import type { Measurable, Scope } from '@briks/core';
...
const Popper: React.FC<PopperProps> = ({ __scopePopper, children }: ScopedProps<PopperProps>) => {
...
const PopperAnchor = React.forwardRef<PopperAnchorElement, PopperAnchorProps>(
  ({ __scopePopper, virtualRef, ...anchorProps }: ScopedProps<PopperAnchorProps>, forwardedRef) => {
      ...
      middleware: [
        ...
        size({
          ...
          apply: ({ elements, rects, availableWidth, availableHeight }) => {
            ...
            contentStyle.setProperty('--popper-content-width', `${anchorWidth}px`);
            contentStyle.setProperty('--popper-content-height', `${anchorHeight}px`);
            contentStyle.setProperty('--popper-content-available-width', `${availableWidth}px`);
            contentStyle.setProperty('--popper-content-available-height', `${availableHeight}px`);
          },
        }),
...
type ArrowProps = Briks.ComponentPropsWithoutRef<typeof ArrowPrimitive>;
type PopperArrowProps = ArrowProps;

const PopperArrow = React.forwardRef<PopperArrowElement, PopperArrowProps>(
  ({ __scopePopper, ...arrowProps }: ScopedProps<PopperArrowProps>, forwardedRef) => {
...
export type { PopperAnchorProps, PopperArrowProps, PopperContentProps, PopperProps };

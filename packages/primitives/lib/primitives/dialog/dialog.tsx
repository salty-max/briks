import { createContext, createContextScope, type Scope } from '@briks/core';
...
const DialogTrigger = React.forwardRef<DialogTriggerElement, DialogTriggerProps>(
  ({ __scopeDialog, ...triggerProps }: ScopedProps<DialogTriggerProps>, forwardedRef) => {
...
const DialogOverlayImpl = React.forwardRef<DialogOverlayImplElement, DialogOverlayImplProps>(
  ({ __scopeDialog, ...overlayProps }: ScopedProps<DialogOverlayImplProps>, forwardedRef) => {
      ...
      <DialogContentImpl
        ...
        onCloseAutoFocus={event => {
          ...
          if (!event.defaultPrevented) {
            if (!hasInteractiveOutsideRef.current) context.triggerRef.current?.focus();
...
const DialogTitle = React.forwardRef<DialogTitleElement, DialogTitleProps>(
  ({ __scopeDialog, ...titleProps }: ScopedProps<DialogTitleProps>, forwardedRef) => {
...
const DialogDescription = React.forwardRef<DialogDescriptionElement, DialogDescriptionProps>(
  ({ __scopeDialog, ...descriptionProps }: ScopedProps<DialogDescriptionProps>, forwardedRef) => {
...
const DialogClose = React.forwardRef<DialogCloseElement, DialogCloseProps>(
  ({ __scopeDialog, ...closeProps }: ScopedProps<DialogCloseProps>, forwardedRef) => {

...
const UndefinedDescribedByDialogTest = (props: React.ComponentProps<typeof Dialog>) => (
  <Dialog {...props}>
    <DialogTrigger>{OPEN_TEXT}</DialogTrigger>
    <DialogOverlay />
...
describe('Dialog', () => {
  describe('given a default Dialog', () => {
    ...
    beforeEach(() => {
      ...
      consoleWarnMock = vi.spyOn(console, 'warn').mockImplementation(consoleWarnMockFn);

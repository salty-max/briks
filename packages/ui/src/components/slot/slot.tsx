 ...
 *
 * @param props -  The props, including children and any additional props to merge.
 ...
 *
 * @param props - The props, including children and any slot-specific props.
 * @param forwardedRef - The ref to forward to the Slot or the cloned element.
 * @returns The slot with potentially replaced content, based on the presence of `Slottable` children.
 */
